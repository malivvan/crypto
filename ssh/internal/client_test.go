...
func TestHostKeyCheck(t *testing.T) {
	for _, tt := range []struct {
		...
		{"correct key", "", testSigners["cert"].PublicKey()},
...
func TestVerifyHostKeySignature(t *testing.T) {
	for _, tt := range []struct {
		...
		{"ed25519", KeyAlgoED25519, KeyAlgoSKED25519, `ssh: invalid signature algorithm "ssh-ed25519", expected "sk-ssh-ed25519@openssh.com"`},
	} {
