...
var ErrUnsupported = errors.New("ptyallocate unsupported")
...
// os/exec: c.Wait() must not be used, and c.Process, c.Err and c.ProcessState
// are filled in instead once the process is done.
