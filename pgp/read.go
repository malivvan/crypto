...
// Package pgp implements high level operations on OpenPGP messages.
package pgp
...
import (
	...
	_ "github.com/malivvan/crypto/sha3"
)

// SignatureType is the armor type for a PGP signature.
const SignatureType = "PGP SIGNATURE"
...
func checkMessageSignatureDetails(verifiedKey *Key, signature *packet.Signature, config *packet.Config) error {
	...
	// Return errors.ErrSignatureExpired last as callers might ignore it.
