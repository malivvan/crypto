...
type Config struct {
	...
	// Simple S2K (mode 0) is only parsed for legacy compatibility and never generated.
	...
	// Hash is the default hash function to be used. Must be one of
	// crypto.SHA256 or crypto.SHA512. If zero, SHA256 is used.
	Hash crypto.Hash
	// Argon2 parameters for S2K (String to Key).
	// Only relevant if S2KMode is set to s2k.Argon2S2K.
	// If nil, default parameters are used.
	// For more details on the choice of parameters, see
	// https://tools.ietf.org/html/rfc9106#section-4.
	...
	// insecure, and not allowed by RFC 9580.
	PassphraseIsHighEntropy bool
}

// Argon2Config stores the Argon2 parameters
// A nil *Argon2Config is valid and results in all default values
